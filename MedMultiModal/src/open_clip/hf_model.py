...
@register_pooler
class LastHiddenStateWithoutClsPooler(nn.Module):
    """Get all token embeddings besides the CLS token."""
...
@register_pooler
class LastHiddenStateOnly(nn.Module):
    """Get all tokens of the last hidden state."""
