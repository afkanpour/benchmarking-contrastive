...
from clip_benchmark.model_collection import (
...
def get_parser_args():
    ...
    parser_eval.add_argument(
        ...
        type=str,
        default="",
        help="Model checkpoint to use with FILIP",
    )
    parser_eval.add_argument(
        "--pretrained_model",
        type=str,
    ...
    parser_eval.add_argument(
        ...
        default="",
        type=str,
        help="Used for setting coca model to use ViT-B-16",
    )
    parser_eval.add_argument(
        "--wds_cache_dir",
        default=None,
...
def run(args):
    ...
    if args.skip_load:
        ...
        model_kwargs = {}
        if "coca" in args.model and args.caption_encoder == "ViT-B-16":
            model_kwargs["caption_encoder"] = args.caption_encoder
        elif args.filip:
            model_kwargs["filip"] = args.filip
        ...
        if args.filip:
            model.token_level_embedding = False
